...
function ProductList({ onHomeClick }) {
    ...
    const textStyle = {
        position: 'absolute',
        top: '45%',          // Vertical center of the basket
        left: '52%',         // Horizontal center of the basket
        transform: 'translate(-50%, -50%)',
        color: '#faf9f9',    // Matches your stroke color
        fontSize: '16px',
        fontWeight: 'bold',
        pointerEvents: 'none', // Allows clicks to pass through to the link
        zIndex: 2            // Ensures
    }
    const cartStyle = {
        position: 'relative',
                ...
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)}>
                            <div>
                                <h3 style={{ color: 'white', marginLeft: '10px' }}> Paradise Nursery</h3>
                                <i style={{ color: 'white', marginLeft: '10px' }}> Where Green Meets Serenity</i>
                            </div>
                        </a>
                    </div>
                ...
                <div className="product-grid">
                    {plantsArray.map((category, index) => (
                        <div key={index}>
                            <span>
                                <h1>
                                    <span style={{ display: 'block', textAlign: 'center' }}>{category.category}</span>
                                </h1>
                            </span>
