...
function requireReact_production_min() {
  ...
  react_production_min.version = "18.3.0";
...
const CartItem = ({ onContinueShopping, onRemoveFromCart }) => {
  ...
  const prevCartRef = reactExports.useRef(cart);
  reactExports.useEffect(() => {
    const prevCart = prevCartRef.current;
    const currentCartNames = cart.map((item) => item.name);
    const prevCartNames = prevCart.map((item) => item.name);
    prevCartNames.forEach((name) => {
  ...
  const calculateTotalAmount = () => {
    const totalAmount = cart.reduce((accumulator, currentItem) => {
      return accumulator + parseFloat(currentItem.cost.substring(1)) * currentItem.quantity;
    }, 0);
    return totalAmount;
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-container", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: cart.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-item", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "cart-item-image", src: item.image, alt: item.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-item-details", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cart-item-name", children: item.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cart-item-cost", children: item.cost }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-item-quantity", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "cart-item-button cart-item-button-dec", onClick: () => handleDecrement(item), children: "-" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "cart-item-quantity-value", children: item.quantity }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "cart-item-button cart-item-button-inc", onClick: () => handleIncrement(item), children: "+" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-item-total", children: [
          "Total: $",
          calculateTotalCost(item)
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "cart-item-delete", onClick: () => handleRemove(item), children: "Delete" })
      ] })
    ] }, item.name)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: "20px", color: "black" }, className: "total_cart_amount" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "continue_shopping_btn", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "get-started-button", onClick: (e) => handleContinueShopping(e), children: "Continue Shopping" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "get-started-button1", onClick: (e) => handleCheckoutShopping(), children: "Checkout" })
    ] })
  ] });
};
function ProductList({ onHomeClick }) {
  const [showCart, setShowCart] = reactExports.useState(false);
  const [showPlants, setShowPlants] = reactExports.useState(false);
  const [addedToCart, setAddedToCart] = reactExports.useState({});
  const dispatch = useDispatch();
  ...
  const textStyle = {
    position: "absolute",
    top: "45%",
    // Vertical center of the basket
    left: "52%",
    // Horizontal center of the basket
    transform: "translate(-50%, -50%)",
    color: "#faf9f9",
    // Matches your stroke color
    fontSize: "16px",
    fontWeight: "bold",
    pointerEvents: "none",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "navbar", style: styleObj, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styleObjUl, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", onClick: (e) => handlePlantsClick(e), style: styleA, children: "Plants" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: cartStyle, children: [
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", onClick: (e) => handleCartClick(e), style: styleA, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "cart", children: [
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 256 256", id: "IconChangeColor", height: "68", width: "68", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "156", height: "156", fill: "none" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "80", cy: "216", r: "12" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "184", cy: "216", r: "12" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M42.3,72H221.7l-26.4,92.4A15.9,15.9,0,0,1,179.9,176H84.1a15.9,15.9,0,0,1-15.4-11.6L32.5,37.8A8,8,0,0,0,24.8,32H8", fill: "none", stroke: "#faf9f9", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", id: "mainIconPathAttribute" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: textStyle, children: calculateTotalQuantity() })
        ] })
      ] })
    ] }),
    !showCart ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "product-grid", children: plantsArray.map((category, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "product-list", children: category.plants.map((plant, plantIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "product-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "product-title", children: plant.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "product-description", children: plant.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "product-cost", children: plant.cost }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
    ...
    ] }, index)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CartItem, { onContinueShopping: handleContinueShopping, onRemoveFromCart: handleRemoveFromCart })
  ] });
}
function AboutUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about-us-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "about-us-description", children: "Welcome to Paradise Nursery, where green meets serenity!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "about-us-content", children: "At Paradise Nursery, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of high-quality plants that not only enhance the beauty of your surroundings but also contribute to a healthier and more sustainable lifestyle. From air-purifying plants to aromatic fragrant ones, we have something for every plant enthusiast." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "about-us-content", children: "Our team of experts is dedicated to ensuring that each plant meets our strict standards of quality and care. Whether you're a seasoned gardener or just starting your green journey, we're here to support you every step of the way. Feel free to explore our collection, ask questions, and let us help you find the perfect plant for your home or office." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "about-us-content", children: "Join us in our mission to create a greener, healthier world. Visit Paradise Nursery today and experience the beauty of nature right at your doorstep." })
  ] });
}
function App() {
  const [showProductList, setShowProductList] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `landing-page ${showProductList ? "fade-out" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "background-image" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "content", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "landing_content", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Welcome To Paradise Nursery" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divider" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Where Green Meets Serenity" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "get-started-button", onClick: handleGetStartedClick, children: "Get Started" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aboutus_container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AboutUs, {}) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `product-list-container ${showProductList ? "visible" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductList, { onHomeClick: handleHomeClick }) })
  ] });
}
